...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String message)?  success,TResult Function( NetworkExceptions networkExceptions)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String message)  success,required TResult Function( NetworkExceptions networkExceptions)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String message)?  success,TResult? Function( NetworkExceptions networkExceptions)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
@override
String toString() {
  return 'SupportTicketState.success(message: $message)';
}
...
class _Failure implements SupportTicketState {
...
@override
String toString() {
  return 'SupportTicketState.failure(networkExceptions: $networkExceptions)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $SupportTicketStateCopyWith<$Res> {
