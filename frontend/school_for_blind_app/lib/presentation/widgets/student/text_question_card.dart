...
import 'package:school_for_blind_app/presentation/widgets/student/input_section.dart';
...
class _TextQuestionCardState extends State<TextQuestionCard> {
  ...
  @override
  void didUpdateWidget(covariant TextQuestionCard oldWidget) {
            ...
            child: Column(
              ...
              children: [
                ...
                InputSection(
                  ...
                  audioFilePrefix:
                      'quiz_question_${widget.question.questionNumber}',
